...
// 30s per test is generous for E2E; prevents CI hangs from emulator issues
...
describe("E2E: Disposal Patterns", async () => {
  ...
  for (const fixture of availableBackends) {
    describe(`${fixture.name}`, () => {
      ...
      it(
        "should automatically release lock on scope exit",
        async () => {
      ...
      it(
        "should release lock even if scope exits with error",
        async () => {
      ...
      it(
        "should support manual release with disposal handle",
        async () => {
      ...
      it(
        "should support extend operation with disposal handle",
        async () => {
      ...
      it(
        "should handle failed acquisition gracefully",
        async () => {
      ...
      it(
        "should allow nested disposal scopes",
        async () => {
      ...
      it(
        "should provide consistent disposal behavior across manual operations",
        async () => {
      ...
      it(
        "should handle concurrent disposal correctly",
        async () => {
          const keys = [
